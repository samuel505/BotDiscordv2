        ...
        if (!args[0]) {
            ...
            message.channel.send({
                embed: {
                    ...
                    footer: { text: 'Este bot fué hecho por samuel505' },
                    fields: [
                    ...
                    timestamp: new Date(),
                    description: `Para usar filtros, ${client.config.discord.prefix}filter (el filtro). Ejemplo :${client.config.discord.prefix}filtro 8D.`,
                },
            });
        } else {
            ...
            message.channel.send({
                embed: {
                    ...
                    timestamp: new Date(),
                    description: 'Encontrar información sobre el comando provisto.\nArgumentos obligatorios `[]`, argumentos opcionales `<>`.',
                }
            });
        };
    },
